      ...
      <Container>
        ...
        <div className="w-full px-10 lg:w-2/3 mx-auto flex flex-col ">
          ...
          <p className="font-normal lg:text-xl text-lg mt-8 text-[#5B5B5B] leading-180">
            In today&apos;s digital landscape, data privacy has become a
            paramount concern, and the General Data Protection Regulation (GDPR)
            stands at the forefront of this movement. As an EU law, GDPR sets
            stringent standards for data protection, fundamentally reshaping the
            way businesses approach data privacy. It&apos;s not just an EU
            concern; any website with EU visitors must comply, making it a
            global priority.
          </p>
          <Link
            href="/login"
